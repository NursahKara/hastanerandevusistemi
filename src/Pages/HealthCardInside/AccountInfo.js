 ...
 {/* <Input
            ...
            <Item style={Sty.app.InputStyle}>
              ...
              <Input
                ...
                ref={input => {this.usersRef=input;
                }}
                onSubmitEditing={() => {
                  this.tcRef._root.focus();
                }}
            ...
            <Item style={Sty.app.InputStyle} ><Text style={{ marginLeft: 5, opacity: 0.8,marginLeft:30 }} >Kan Grubu :</Text>
            <Picker
              ...
              >
                <Picker.Item style={{ marginLeft: 15, opacity: 0.8 }} label="0 RH +" value="0rh+" />
                <Picker.Item style={{ marginLeft: 15, opacity: 0.8 }} label="0 RH -" value="0rh-" />
                <Picker.Item style={{ marginLeft: 15, opacity: 0.8 }} label="A RH +" value="arh+" />
                <Picker.Item style={{ marginLeft: 15, opacity: 0.8 }} label="A RH -" value="arh-" />
                <Picker.Item style={{ marginLeft: 15, opacity: 0.8 }} label="B RH +" value="brh+" />
                <Picker.Item style={{ marginLeft: 15, opacity: 0.8 }} label="B RH -" value="brh-" />
                <Picker.Item style={{ marginLeft: 15, opacity: 0.8 }} label="AB RH +" value="abrh+" />
                <Picker.Item style={{ marginLeft: 15, opacity: 0.8 }} label="AB RH -" value="abrh-" />
